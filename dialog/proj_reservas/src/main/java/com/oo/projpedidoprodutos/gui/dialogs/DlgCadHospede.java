...
import com.oo.projpedidoprodutos.gerenciador.GerenciadorHospede;
 ...
 * @author kfrural
 */
public class DlgCadHospede extends javax.swing.JDialog {
    
     private boolean editando;
    private String cpfEscolhido;
    private Hospede pessoaEditando;
    private GerenciadorHospede gerenciadorHospedes;
    
     public DlgCadHospede() {
        this.gerenciadorHospedes = new GerenciadorHospede();
        this.pessoaEditando = new Hospede();
        this.editando = false;
        this.cpfEscolhido = "";
        ...
        this.gerenciadorHospedes.carregarDoArquivo("ListagemHospedes.csv");
        String listagem = this.gerenciadorHospedes.toString();
    ...
    public void objetoParaCampos(Hospede p) {
        edtNome.setText(p.getNome());
        edtCPF.setText(p.getCpf());
        edtEndereco.setText(p.getSexo() + "");
        edtContato.setText(p.getIdade() + "");
    ...
    /**
     * Creates new form DlgHospede
     */
    public DlgCadHospede(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Cadastro de Hospede");
            ...
            .addGroup(panFieldsLayout.createSequentialGroup()
                ...
                .addGroup(panFieldsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panFieldsLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(edtContato, javax.swing.GroupLayout.PREFERRED_SIZE, 111, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        Hospede p = this.gerenciadorHospedes.buscarHospede(cpfEscolhido);

        if (p == null) {
            JOptionPane.showMessageDialog(this, "Não existe este cpf.");
        } else {
            this.gerenciadorHospedes.removerHospede(cpfEscolhido);
            JOptionPane.showMessageDialog(this, "Exclusão feita com sucesso!");
        }

        edtListagem.setText(this.gerenciadorHospedes.toString());

        //Salvando no arquivo
        this.gerenciadorHospedes.salvarNoArquivo("ListagemHospedes.csv");
    }//GEN-LAST:event_btnExcluirActionPerformed

    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
       Hospede novaHospede = this.camposParaObjeto();

        if (this.editando == true) {
            this.gerenciadorHospedes.atualizarHospede(cpfEscolhido, novaHospede);
        } else { //Estou inserindo
            this.gerenciadorHospedes.adicionarHospede(novaHospede);
        }

        this.limparCampos();
        this.habilitarCampos(false);

        String listagem = gerenciadorHospedes.toString();
        edtListagem.setText(listagem);
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        this.pessoaEditando = this.gerenciadorHospedes.buscarHospede(cpfEscolhido);
...
//            java.util.logging.Logger.getLogger(DlgCadHospede.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                DlgCadHospede dialog = new DlgCadHospede(new javax.swing.JFrame(), true);
