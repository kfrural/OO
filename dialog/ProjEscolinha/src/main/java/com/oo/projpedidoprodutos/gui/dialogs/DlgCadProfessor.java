...
import com.oo.projpedidoprodutos.gerenciador.GerenciadorProfessor;
...
public class DlgCadProfessor extends javax.swing.JDialog {
    ...
    public Professor camposParaObjeto() {
        ...
        String sexo = edtMateria.getText();
        if (!sexo.isEmpty()) {
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        edtListagem.setText(this.gerenciadorProfessors.toString());

        //Salvando no arquivo
        this.gerenciadorProfessors.salvarNoArquivo("ListagemProfessors.csv");
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
       Professor novaProfessor = this.camposParaObjeto();
        ...
        String listagem = gerenciadorProfessors.toString();
        edtListagem.setText(listagem);
