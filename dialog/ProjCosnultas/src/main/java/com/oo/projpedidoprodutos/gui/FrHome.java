...
import com.oo.projpedidoprodutos.gui.dialogs.DlgCadConsulta;
import com.oo.projpedidoprodutos.gui.dialogs.DlgCadMedico;
import com.oo.projpedidoprodutos.gui.dialogs.DlgCadPaciente;
...
public class FrHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Consultas Medicas");

        btnCadProf.setText("Cad Pacientes");
        ...
        btnCadAluno.setText("Cad Medicos");
        ...
        btnCadDisciplina.setText("Cad Consultas");
        ...
        mnPedidos.setText("Novo Paciente");
        ...
        mnCadProdutos.setText("Cad Medico");
        ...
        mnCadClientes.setText("Cad Consultas");
    ...
    private void btnCadProfActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadProfActionPerformed
        DlgCadPaciente cadPaciente = new DlgCadPaciente();
    ...
    private void btnCadDisciplinaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadDisciplinaActionPerformed
        DlgCadConsulta cadConsulta = new DlgCadConsulta();
    ...
    private void btnCadAlunoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadAlunoActionPerformed
        DlgCadMedico cadMedico = new DlgCadMedico();
