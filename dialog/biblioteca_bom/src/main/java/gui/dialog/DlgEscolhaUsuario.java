 ...
 * @author jose
 */
public class DlgEscolhaUsuario extends javax.swing.JDialog {

    private Avaliacao avaliacao;
    public Usuario pessoaEscolhida;
    private GerenciadorUsuario gerenteUsuario;

    public DlgEscolhaUsuario(java.awt.Frame parent, boolean modal, Avaliacao avaliacao) {

        super(parent, modal);
        initComponents();
        this.pessoaEscolhida = new Usuario();
        this.avaliacao = avaliacao;

        this.gerenteUsuario = new GerenciadorUsuario();
        this.gerenteUsuario.carregarNoArquivo("ListagemPessoas.csv");
        String listagem = this.gerenteUsuario.toString();
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        ...
        if (!cpfEscolhido.isEmpty()) {
            pessoaEscolhida = this.gerenteUsuario.buscarUsuario(cpfEscolhido);
    ...
    private void btnAddPessoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddPessoaActionPerformed
        if (pessoaEscolhida == null) {
            ...
            this.avaliacao.setUsuario(pessoaEscolhida);
            dispose();
        }
